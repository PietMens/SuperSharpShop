...
namespace SuperSharpShop
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Item BattlefieldV = new Item("Star Wars Battlefront II", "Game", 59.99, "../../IMG/starwarsbattlefront.jpeg", "Star Wars Battlefront II features a single-player story mode, a customizable character class system, and content based on The Force Awakens and The Last Jedi movies. It also features vehicles and locations from the original, prequel, and sequel Star Wars movie trilogies.", "shop");
